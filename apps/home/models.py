...
class SiteSettings(BaseSetting):
    navbar_no_backdrop = models.OneToOneField(Image, null=True, blank=True, on_delete=models.SET_NULL, related_name='+', verbose_name="The background of the navbar, when there's no backdrop support in the browser")
    logo = models.OneToOneField(Image, null=True, blank=True, on_delete=models.SET_NULL, related_name='+', verbose_name='logo')
    panels = [
        ImageChooserPanel('logo'),
        ImageChooserPanel('navbar_no_backdrop'),
    ]